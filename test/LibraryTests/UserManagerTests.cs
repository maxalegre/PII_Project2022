...
using Library;
    ...
    public class UserTests
    {
        ...
        public void CheckCredentialsTest()
        {
            ...
            IUser User = new Employer("Franco", "San Martin", ID, "employer", "Uruguay", "123456789", "Franco@email.com");
        ...
        public void LoginTest()
        {
            ...
            Assert.AreEqual(ExpectedRol, ((Employer)UserManager.Instance.Login(ID)).Rol);
